...
def order(total_pizza_made, total_cost_pizza):
    ...
    if confirm == "yes":
        ...
        print(make_statement("Thank you for shopping at Liam's Pizzas!", "🍕"))
    else:
...
pizza_list = ["Pepperoni", "Meat Lovers", "Hawaiian", "Cheese", "Vegetarian"]
toppings_list = ["Anchovies", "Cheese", "Pineapple", "Olives", "Peppers"]

print(make_statement("Pizza Shop", "🍕"))
print()
